...
Object.defineProperty(Group.prototype, 'allow_sending', {
    enumerable: true,
    get: function() { return this.get('allow_sending'); },
    set: function(value) { this.set('allow_sending', value); }
});

Object.defineProperty(Group.prototype, 'add_time_variable', {
    enumerable: true,
    get: function() { return this.get('add_time_variable'); },
    set: function(value) { this.set('add_time_variable', value); }
});
