...
Project.prototype.getContactById = function(id, callback)
{
    ...
    var res = new Contact(this.api, {'project_id': this.id, 'id': id}, false);
...
Project.prototype.getPhoneById = function(id, callback)
{
    ...
    var res = new Phone(this.api, {'project_id': this.id, 'id': id}, false);
    if (callback) { res.load(callback); }
    return res;
};
...
Project.prototype.getMessageById = function(id, callback)
{
    ...
    var res = new Message(this.api, {'project_id': this.id, 'id': id}, false);
    if (callback) { res.load(callback); }
    return res;
};
...
Project.prototype.getGroupById = function(id, callback)
{
    ...
    var res = new Group(this.api, {'project_id': this.id, 'id': id}, false);
    if (callback) { res.load(callback); }
    return res;
};
...
Project.prototype.getLabelById = function(id, callback)
{
    ...
    var res = new Label(this.api, {'project_id': this.id, 'id': id}, false);
    if (callback) { res.load(callback); }
    return res;
};
...
Project.prototype.getDataTableById = function(id, callback)
{
    ...
    var res = new DataTable(this.api, {'project_id': this.id, 'id': id}, false);
    if (callback) { res.load(callback); }
    return res;
};
...
Project.prototype.getScheduledMessageById = function(id, callback)
{
    ...
    var res = new ScheduledMessage(this.api, {'project_id': this.id, 'id': id}, false);
    if (callback) { res.load(callback); }
    return res;
};
...
Project.prototype.getServiceById = function(id, callback)
{
    ...
    var res = new Service(this.api, {'project_id': this.id, 'id': id}, false);
    if (callback) { res.load(callback); }
    return res;
};
...
Project.prototype.getReceiptById = function(id, callback)
{
    ...
    var res = new MobileMoneyReceipt(this.api, {'project_id': this.id, 'id': id}, false);
    if (callback) { res.load(callback); }
    return res;
};
