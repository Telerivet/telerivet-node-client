...
/**
    project.createRelativeScheduledMessage(options, callback)
    ...
    Arguments:
      ...
      - callback : function(err, rel_scheduled_msg)
          * Required
    */
Project.prototype.createRelativeScheduledMessage = function(options, callback)
{
    this.api.doRequest("POST", this.getBaseApiPath() + "/relative_scheduled", options, this.api.wrapCallback(require('./relativescheduledmessage'), callback));
};
...
/**
    ...
    */
Project.prototype.queryRelativeScheduledMessages = function(options)
{
    return this.api.cursor(require('./relativescheduledmessage'), this.getBaseApiPath() + "/relative_scheduled", options);
};
...
/**
    project.getRelativeScheduledMessageById(id, callback)
    ...
    Arguments:
      ...
      - callback : function(err, rel_scheduled_msg)
          * Required
    */
Project.prototype.getRelativeScheduledMessageById = function(id, callback)
{
    this.api.doRequest("GET", this.getBaseApiPath() + "/relative_scheduled/" + id, null, this.api.wrapCallback(require('./relativescheduledmessage'), callback));
};
...
/**
    ...
    */
Project.prototype.initRelativeScheduledMessageById = function(id)
{
    var RelativeScheduledMessage = require('./relativescheduledmessage');
    return new RelativeScheduledMessage(this.api, {'project_id': this.id, 'id': id}, false);
};

/**
    project.createService(options, callback)
    ...
    Arguments:
      ...
      - callback : function(err, service)
          * Required
    */
Project.prototype.createService = function(options, callback)
{
    this.api.doRequest("POST", this.getBaseApiPath() + "/services", options, this.api.wrapCallback(require('./service'), callback));
};
...
/**
    ...
    */
Project.prototype.queryServiceLogs = function(options)
{
    return this.api.cursor(null, this.getBaseApiPath() + "/service_logs", options);
};
...
/**
    project.getContactFields(callback)
    ...
    updated.)
      ...
      - callback : function(err, res)
          * Required
    */
Project.prototype.getContactFields = function(callback)
{
    this.api.doRequest("GET", this.getBaseApiPath() + "/contact_fields", null, callback);
};

/**
    project.setContactFieldMetadata(variable, options, callback)
    ...
    Arguments:
      ...
      - callback : function(err, res)
          * Required
    */
Project.prototype.setContactFieldMetadata = function(variable, options, callback)
{
    this.api.doRequest("POST", this.getBaseApiPath() + "/contact_fields/" + variable, options, callback);
};

/**
    project.getMessageFields(callback)
    ...
    updated.)
      ...
      - callback : function(err, res)
          * Required
    */
Project.prototype.getMessageFields = function(callback)
{
    this.api.doRequest("GET", this.getBaseApiPath() + "/message_fields", null, callback);
};

/**
    project.setMessageFieldMetadata(variable, options, callback)
    ...
    Arguments:
      ...
      - callback : function(err, res)
          * Required
    */
Project.prototype.setMessageFieldMetadata = function(variable, options, callback)
{
    this.api.doRequest("POST", this.getBaseApiPath() + "/message_fields/" + variable, options, callback);
};

/**
    project.getMessageStats(options, callback)
    ...
    Arguments:
      ...
      - callback : function(err, res)
          * Required
    */
Project.prototype.getMessageStats = function(options, callback)
{
...
Object.defineProperty(Project.prototype, 'url_slug', {
    ...
    set: function(value) { this.set('url_slug', value); }
});

Object.defineProperty(Project.prototype, 'default_route_id', {
    enumerable: true,
    get: function() { return this.get('default_route_id'); },
    set: function(value) { this.set('default_route_id', value); }
});

Object.defineProperty(Project.prototype, 'auto_create_contacts', {
    enumerable: true,
    get: function() { return this.get('auto_create_contacts'); },
    set: function(value) { this.set('auto_create_contacts', value); }
});
