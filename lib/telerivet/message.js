...
/**
    ...
    new message object.
      ...
      - callback : function(err, message)
          * Required
    */
Message.prototype.resend = function(callback)
{
    this.api.doRequest("POST", this.getBaseApiPath() + "/resend", null, this.api.wrapCallback(require('./message'), callback));
};
