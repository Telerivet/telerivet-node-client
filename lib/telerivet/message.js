...
Object.defineProperty(Message.prototype, 'send_attempts', {
    enumerable: true,
    get: function() { return this.get('send_attempts'); },
    set: function(value) { throw new Error('send_attempts is not writable'); }
});
...
Object.defineProperty(Message.prototype, 'error_code', {
    enumerable: true,
    get: function() { return this.get('error_code'); },
    set: function(value) { throw new Error('error_code is not writable'); }
});
